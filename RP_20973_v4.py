...
# Timestamps added
# Timestamps for each location for each NEID
...
with open('tables_v4.csv', 'w', encoding='UTF8', newline='') as f:
    ...
    with open('Montreal_Island_Stats_Location.csv', mode='r') as reference_file:

        df = pd.read_csv('Montreal_Island_Stats_Location.csv')
